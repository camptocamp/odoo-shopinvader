...
class WishlistCase(CommonWishlistCase):
    ...
    def _test_update_items(self, prods, lines_data):
        ...
        for line in lines_data:
            line = self.prod_set.get_lines_by_product(
    ...
    def test_update_item_order(self):
        ...
        line1 = self.prod_set.get_lines_by_product(product_ids=prod1.ids)
        line1.sequence = 10
        ...
        line2 = self.prod_set.get_lines_by_product(product_ids=prod2.ids)
    ...
    def test_delete_items(self):
        ...
        line = self.prod_set.get_lines_by_product(product_ids=prod.ids)
