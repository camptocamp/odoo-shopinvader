...
class TestCart(CommonConnectedCartCase, TestSaleCouponCommon):
    ...
    def test_code_promotion_program(self):
        ...
        self.service.dispatch("apply_coupon", "fakecode")
        self.assertEqual(
            len(self.cart.order_line.ids),
            1,
            "The promo shouldn't have been applied",
        )
        # Enter code
        self.service.dispatch("apply_coupon", "promocode")
        self.assertEqual(
            len(self.cart.order_line.ids),
            2,
    ...
    def test_code_promotion_program_coupons(self):
        ...
        # Enter code
        self.service.dispatch("apply_coupon", coupon.code)
        self.assertEqual(
            len(self.cart.order_line.ids),
            2,
            "The promo should've been applied",
    ...
    def test_code_promotion_program_through_update(self):
        self.code_promotion_program.promo_code = "promocode"
        # Buy 1 A + Enter code, 1 A is free
        self.service.dispatch(
            "add_item",
        ...
        # Enter code
        self.service.dispatch("update", params={"coupon_code": "promocode"})
        self.assertEqual(
            len(self.cart.order_line.ids),
            2,
            "The promo should've been applied",
