...
class ProductCase(ProductCommonCase):
    ...
    def test_translation_update_url(self):
        ...
        self.assertEqual(binding_en.automatic_url_key, "customizable-desk")
        self.assertEqual(binding_fr.automatic_url_key, "bureau-modifiable")
        ...
        self.assertEqual(binding_fr.automatic_url_key, "bureau-customisable")
