...
class ProductLinkCaseBase(ProductCommonCase):
    ...
    def setUpClass(cls):
        ...
        cls.shopinvader_variant_1_1 = cls.variant_1_1._get_invader_variant(cls.backend, "en_US")
        cls.shopinvader_variant_1_2 = cls.variant_1_2._get_invader_variant(cls.backend, "en_US")
        cls.shopinvader_variant_2_1 = cls.variant_2_1._get_invader_variant(cls.backend, "en_US")
        cls.shopinvader_variant_2_2 = cls.variant_2_2._get_invader_variant(cls.backend, "en_US")
        cls.shopinvader_variant_3_1 = cls.variant_3_1._get_invader_variant(cls.backend, "en_US")
        cls.shopinvader_variant_3_2 = cls.variant_3_2._get_invader_variant(cls.backend, "en_US")
...
class ProductLinkCase(ProductLinkCaseBase):
    ...
    def test_links(self):
        ...
        main1 = self.template_1.mapped("shopinvader_bind_ids.shopinvader_variant_ids").filtered(lambda x: x.main)
        main2 = self.template_2.mapped("shopinvader_bind_ids.shopinvader_variant_ids").filtered(lambda x: x.main)
        main3 = self.template_3.mapped("shopinvader_bind_ids.shopinvader_variant_ids").filtered(lambda x: x.main)

        expected = {
            "up_selling": [{"id": main2.record_id.id}],
            "cross_selling": [{"id": main3.record_id.id}],
        }
        self.assertEqual(self.shopinvader_variant_1_1.shopinvader_product_id.product_links, expected)
        self.assertEqual(self.shopinvader_variant_1_2.shopinvader_product_id.product_links, expected)

        expected = {
            "cross_selling": [{"id": main3.record_id.id}],
            "up_selling": [{"id": main1.record_id.id}],
        }
        self.assertEqual(self.shopinvader_variant_2_1.shopinvader_product_id.product_links, expected)
        self.assertEqual(self.shopinvader_variant_2_2.shopinvader_product_id.product_links, expected)
