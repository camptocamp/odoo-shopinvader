...
class CartsService(Component):
    ...
    def new(self):
        ...
        It's in fact clearing the current session's cart_id, which would be the same
        as "unselecting" the current cart.

        The actual new cart gets later created on-demand by the cart service.
