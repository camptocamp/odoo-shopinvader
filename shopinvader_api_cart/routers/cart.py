...
class ShopinvaderApiCartRouterHelper(models.AbstractModel):
    ...
    def _apply_transactions_on_existing_cart_line(
        ...
        vals = self._apply_transactions_on_existing_cart_line__post(
    ...
    @api.model
    def _apply_transactions_on_existing_cart_line__post(
        self, line: SaleOrderLine, transactions: list[CartTransaction], values: dict,
    ):
    ...
    def _apply_transactions_creating_new_cart_line(
        ...
        if vals:
            vals = self._apply_transactions_creating_new_cart_line__post(
    ...
    @api.model
    def _apply_transactions_creating_new_cart_line__post(
